...
class TravelApp:
    ...
    def timeline_editor_popup(self, current_timeline, time_var, save_callback):
    ...
    def logout(self):
        ...
        if messagebox.askokcancel(LANG[self.language]["confirm"], LANG[self.language]["confirm_logout"], parent=self.master):
            for widget in self.master.winfo_children():
                widget.destroy()
            LoginWindow(self.master, self.language) # Tạo lại cửa sổ Login
